<aside
    class="fixed top-0 left-0 z-20 h-screen pt-14 -translate-x-full bg-white border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700 transition-all duration-300 ease-in-out"
