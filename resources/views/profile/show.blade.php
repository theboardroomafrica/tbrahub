...
<section class="container cv my-16">
    ...
    @if($actions)
        <div class="w-1/2 mx-auto text-center">
            <h2>Copy and share link</h2>
            <div class="relative mb-4 w-full mt-2">
                <input id="api-key" type="text"
                       ...
                       readonly/>
                {{--                <button id="copy-url" data-copy-to-clipboard-target="api-key" data-tooltip-target="tooltip-api-key"--}}
